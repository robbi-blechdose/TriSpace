...
const ShipTypeData shipTypes[NUM_SHIP_TYPES] = {
    ...
    [SHIP_TYPE_SMALLPIRATE3] = {.maxSpeed = 12, .maxTurnSpeed = 2.1, .maxShields = 8, .maxEnergy = 6, .shieldRegen = 0.6f, .energyRegen = 1, .hitSphere = 1.5f},
...
const char* shipAssets[NUM_SHIP_TYPES][2] = {
    ...
    [SHIP_TYPE_SMALLPIRATE3] = {"res/obj/ships/Ship_03.obj", "res/tex/ships/Ship_03.png"},
